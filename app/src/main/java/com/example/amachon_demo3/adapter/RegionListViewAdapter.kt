...
class RegionListViewAdapter(val List : MutableList<TagDto>) : BaseAdapter() {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(p2?.context).inflate(R.layout.regiontaglistview_item, p2, false)
        }
